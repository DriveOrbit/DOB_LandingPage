    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="container mx-auto px-4 py-6 flex justify-between items-center">
          <img src="https://avatars.githubusercontent.com/u/188688275?s=400&u=856b48def80550c9fce1c213ecdcb801a41fe0c6&v=4" alt="DriveOrbit Logo" className="h-10" onError={(e) => console.error('Image not found:', e)} />
